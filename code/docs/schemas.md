...
| `likes`              | `Number`      | The total number of likes a user's profile has received.                                   |
| `likedBy`            | `Array<String>`| An array of `userId`s who have 'liked' the user's profile.                                              |
...
| `type`         | `String`  | The category of the notification (e.g., "friend\_request", "verification\_request"). |
