...
/**
 * This file contains all the static constant data used throughout the application.
 * This makes it easy to update values like alliance names, ranks, or post types
 * without searching through all the logic files.
 */
